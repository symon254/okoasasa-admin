...
import logoIcon from '@/assets/icons/sidebarLogo.svg'
...
export const CogIcon = ({ size, className = '' }) => (
  <img
    src={cogIcon}
    alt="cogIcon"
    width={size}
...
export const AnalyticIcon = ({ size, className = '' }) => (
  <img
    src={analyticIcon}
    alt="analyticIcon"
    width={size}
...
export const RequestIcon = ({ size, className = '' }) => (
  <img
    src={requestIcon}
    alt="requestIcon"
    width={size}
