...
// DeactivateUserDialog.jsx
import { PauseWhiteIcon } from '@/assets/icons'
import { Button } from '@/components/ui/button'
import { X } from 'lucide-react'

const DeactivateUserDialog = ({ open, onOpenChange, user, onConfirm }) => {
  const handleClose = () => {
    onOpenChange(false)
  }
  ...
  return (
    <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-2xl max-w-sm w-full p-6 text-center">
        ...
        {/* Warning Icon */}
        <div className="mx-auto w-[113px] h-[113px] bg-orange-500 rounded-full flex items-center justify-center mb-4">
          <PauseWhiteIcon />
        </div>
        ...
        <p className="text-sm text-gray-600 mb-6">
          Are you sure you want to deactivate {user?.name}? They will lose
